    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0" style = " color : #848484;">New Posts Page</h1>
                <!-- Icon Divider-->
               ...
               <h1>
               <a href="new.jsp" style = "color : #848484";>&nbsp1&nbsp</a>
               <a href="new.jsp" style = "color : #848484";>2&nbsp</a>
               <a href="new.jsp" style = "color : #848484";>3&nbsp</a>
               <a href="new.jsp" style = "color : #848484";>4&nbsp</a>
               <a href="new.jsp" style = "color : #848484";>5&nbsp</a>
               <a href="new.jsp" style = "color : #848484";>&nbsp></a>
               </h1>
                <hr>
