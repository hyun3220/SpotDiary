		...
		<!-- <section class="page-section freeB" id="freeB"> -->
	        <div class = "container">
				...
				<%
					if(pageNumber != 1) {
				%>	
					<a href = "freeBoard.jsp?pageNumber=<%=pageNumber - 1 %>" class=" btn btn-arraw-left">◀이전</a>
				<% 	
					} if(bbsDAO.nextPage(pageNumber + 1)) {			
				%>
					<a href = "freeBoard.jsp?pageNumber=<%=pageNumber + 1%>" class=" btn btn-arraw-left">다음▶</a>
				<%
					}					
				%>		
	  			<a href = "write.jsp" class = "btn pull-right mx-1 mt-2">글쓰기</a>		  		
	 	 	</div><br/>
        <!-- </section> -->
