    ...
    <body id="page-top" >
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0" style = "color: #DB9CFF;">Welcome to Spot Diary</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="pre-wrap masthead-subheading font-weight-light mb-0" style = "color: #DB9CFF;">Example of Graduation Project [ver 1.5.2] </p>
                ...
                <article> <img class="masthead-avatar mb-5" src="assets/img/mainimage/cafe-3.png"></article>
				 ...
				 <hr color="#D941C5">
				<text1><a href="new.jsp" style = "color: #D941C5"><b>new ></b></a></text1>
                ...
                <div id="wrap">
                 <hr color="#D941C5">
                 <text1><a href="hot.jsp" style = "color: #D941C5"><b>hot > </b></a> </text1>
                <!--<gr color="black">  -->
