    ...
    <body id="page-top" >
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Icon Divider-->
                <div class="divider-custom divider-light" style = "background-olor: #D3CBD5;">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                    <div class="divider-custom-line"></div>
                </div>
                <!-- Masthead Subheading-->
                <p class="pre-wrap masthead-subheading font-weight-light mb-0" style = "color:#D3CBD5;">Example of Graduation Project [ver 1.5.2] </p>
                ...
                <article> <img class="masthead-avatar mb-5" src="assets/img/mainimage/cafe-3.png"></article>
				 ...
				 <hr color=" #A9A6A9">
				<text1><a href="new.jsp" style = "color: #A9A6A9"><b>new ></b></a></text1>
                ...
                <div id="wrap">
                 <hr color="#A9A6A9">
                 <text1><a href="hot.jsp" style = "color: #A9A6A9;"><b>hot > </b></a> </text1>
                <!--<gr color="black">  -->
